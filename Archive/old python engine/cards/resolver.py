...
from cards.priority_handlers import (
    ...
    handle_parazs_szilank,
    handle_verforralo_uvoltes,
    handle_tuzgyuru,
    ...
    can_activate_izzo_aura,
    can_activate_langolo_visszavagas,
    can_activate_robbano_pajzs,
    can_activate_tuzes_megtorlas,
...
ON_PLAY_HANDLERS = {
    ...
    "a langok haragja": handle_a_langok_haragja,
    ...
    "gyongy-kovacs": handle_gyongy_kovacs,
    "gyongy kovacs": handle_gyongy_kovacs,
    ...
    "parazs-szilank": handle_parazs_szilank,
    "parazs szilank": handle_parazs_szilank,
    "verforralo uvoltes": handle_verforralo_uvoltes,
...
TRAP_HANDLERS = {
    ...
    "hamis parancs": handle_hamis_parancs,
    ...
    "langolo visszavagas": handle_langolo_visszavagas,
    "robbano pajzs": handle_robbano_pajzs,
...
SUMMON_TRAP_HANDLERS = {
    ...
    "csapda a hamuban": handle_csapda_a_hamuban,
...
TRAP_PREVIEW_HANDLERS = {
    ...
    "hamis parancs": can_activate_hamis_parancs,
    ...
    "izzo aura": can_activate_izzo_aura,
    ...
    "langolo visszavagas": can_activate_langolo_visszavagas,
    "robbano pajzs": can_activate_robbano_pajzs,
    "tuzes megtorlas": can_activate_tuzes_megtorlas,
