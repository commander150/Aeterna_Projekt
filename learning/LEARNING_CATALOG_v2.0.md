...
| 54 | `pokemon-cards-css-main` | 6 | [simeydotme/pokemon-cards-css](https://github.com/simeydotme/pokemon-cards-css) | megerősített upstream; vizsgált commit `acb1197633e749a1fba4412231db2f6581586d00`; kapcsolódó hivatalos 151 repo `simeydotme/pokemon-cards-151` commit `98030f941cdc4919b648457200277e29b60d5f5a` | CSS/Svelte holografikus kártya showcase és ritkaságalapú fóliaanyag-katalógus | Svelte / JavaScript / CSS 3D / gradients / masks / blend modes / filters | Kiemelt `FoilProfile`, pointer-/giroszkópvezérelt spektrum, maszkolás, glitter-parallax, glare és performance-tier referencia. A szerző szerint showcase, nem modul; nagy teljesítményköltség, GPL-3.0 és Pokémon/külső assetkockázat | **P1** | első teljes source-family audit elkészült; csak clean-room Godot shader- és material-inspirációként használható |

### 3.1 Forráslista-egyeztetés

Az aktuális forrásnyilvántartás hat gyűjtési körben **54 projektet** tart nyilván.
...
- elkészült a `simeydotme/pokemon-cards-css` holografikus source family első teljes AETERNA-központú auditja;
- az elkészült projektszintű elemzések száma tizenötre frissült;
- a célzott vizuális forrás hatodik gyűjtési körként és 54. projektként bekerült;
- bekerült az elsődleges vizsgált commit és a kapcsolódó `pokemon-cards-151` repository;
- feldolgozásra került a pointer-/giroszkópvezérelt tilt, spektrum, glare, mask és glitter rendszer;
- rögzítésre került a ritkaságalapú material recipe és a javasolt AETERNA `FoilProfile`;
- rögzítésre került a requestAnimationFrame-jellegű frame-throttling és a performance-tier követelmény;
- rögzítésre került a szerző demonstrációs, nem moduláris minősítése és teljesítményfigyelmeztetése;
- rögzítésre került mindkét Pokémon CSS repository GPL-3.0 licence;
- rögzítésre kerültek a Pokémon-, külső texture- és CDN-provenance kockázatok;
- közvetlen kód- és assetintegráció elutasítva, clean-room Godot shader/material újraimplementáció ajánlott;
- a normál learning sorozat következő projektje változatlanul a `Valyreon/seven-card-game-godot`.
