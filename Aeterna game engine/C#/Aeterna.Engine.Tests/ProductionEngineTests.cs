...
internal static class ProductionEngineTests
{
    ...
    [
        new("canonical_registry_and_carddatabase_load_preserves_all_fields", CanonicalPackageLoaderTests.SuccessfulRegistryAndCardDatabaseLoadPreservesAllFields),
        new("canonical_materialization_smoke_process_boundary", CanonicalMaterializationSmokeTests.EntryPointContractsAreControlledAndDiagnostic),
        new("canonical_manifest_driven_filename_resolution", CanonicalPackageLoaderTests.ManifestDrivenFilenameResolutionWorks),
        new("canonical_missing_file_is_rejected", CanonicalPackageLoaderTests.MissingFileIsRejected),
        new("canonical_missing_manifest_and_meta_are_rejected", CanonicalPackageLoaderTests.MissingManifestAndMetaAreRejected),
        new("canonical_malformed_json_is_rejected", CanonicalPackageLoaderTests.MalformedJsonIsRejected),
        new("canonical_duplicate_logical_table_is_rejected", CanonicalPackageLoaderTests.DuplicateLogicalTableIsRejected),
        new("canonical_duplicate_primary_record_id_is_rejected", CanonicalPackageLoaderTests.DuplicatePrimaryRecordIdIsRejected),
        new("canonical_unsupported_export_format_is_rejected", CanonicalPackageLoaderTests.UnsupportedExportFormatIsRejected),
        new("canonical_manifest_and_table_identity_mismatch_is_rejected", CanonicalPackageLoaderTests.ManifestAndTableIdentityMismatchIsRejected),
        new("canonical_production_tbd_is_rejected", CanonicalPackageLoaderTests.ProductionTbdIsRejected),
        new("canonical_development_tbd_is_preserved", CanonicalPackageLoaderTests.DevelopmentTbdIsPreserved),
        new("canonical_missing_null_sentinel_is_rejected", CanonicalPackageLoaderTests.MissingNullSentinelIsRejected),
        new("canonical_missing_tbd_sentinel_is_rejected", CanonicalPackageLoaderTests.MissingTbdSentinelIsRejected),
        new("canonical_invalid_null_sentinel_is_rejected", CanonicalPackageLoaderTests.InvalidNullSentinelIsRejected),
        new("canonical_invalid_tbd_sentinel_is_rejected", CanonicalPackageLoaderTests.InvalidTbdSentinelIsRejected),
        new("canonical_valid_sentinel_contract_is_accepted", CanonicalPackageLoaderTests.ValidSentinelContractIsAccepted),
        new("canonical_export_filename_contract_is_exact", CanonicalPackageLoaderTests.ExportFilenameContractIsExactAndPlatformIndependent),
        new("canonical_duplicate_record_field_is_rejected", CanonicalPackageLoaderTests.DuplicateRecordFieldIsRejectedWithStableCode),
        new("canonical_registry_version_incompatibility_is_rejected", CanonicalPackageLoaderTests.RegistryVersionIncompatibilityIsRejected),
        new("canonical_catalog_is_immutable_and_ordinal", CanonicalPackageLoaderTests.CanonicalCatalogIsImmutableAndOrdinal),
        new("canonical_ability_intrinsic_keyword_only", CanonicalAbilityCatalogTests.IntrinsicKeywordOnlyCardMaterializes),
        new("canonical_ability_single_target_triggered_graph", CanonicalAbilityCatalogTests.SingleTargetTriggeredGraphMaterializes),
        new("canonical_ability_ign_ham_044_resolution_graph", CanonicalAbilityCatalogTests.IgnHam044ResolutionGraphMaterializes),
        new("canonical_ability_sequential_multi_effect_graph", CanonicalAbilityCatalogTests.SequentialMultiEffectGraphMaterializes),
        new("canonical_ability_condition_expression_filter", CanonicalAbilityCatalogTests.ConditionExpressionFilteredTargetMaterializes),
        new("canonical_ability_static_restriction_graph", CanonicalAbilityCatalogTests.StaticRestrictionGraphMaterializes),
        new("canonical_ability_mass_temporary_buff_graph", CanonicalAbilityCatalogTests.MassTemporaryBuffGraphMaterializes),
        new("canonical_ability_template_instance_normalization", CanonicalAbilityCatalogTests.TemplateInstanceNormalizesWithProvenance),
        new("canonical_ability_catalog_immutable_deterministic_lossless", CanonicalAbilityCatalogTests.CatalogIsImmutableDeterministicAndLossless),
        new("canonical_ability_missing_parent", CanonicalAbilityCatalogTests.MissingParentAbilityIsRejected),
        new("canonical_ability_missing_effect_target", CanonicalAbilityCatalogTests.MissingEffectTargetIsRejected),
        new("canonical_ability_cross_scope_target", CanonicalAbilityCatalogTests.CrossAbilityTargetReferenceIsRejected),
        new("canonical_ability_missing_duration_effect", CanonicalAbilityCatalogTests.MissingDurationEffectIsRejected),
        new("canonical_ability_invalid_sequence_type", CanonicalAbilityCatalogTests.InvalidSequenceTypeIsRejected),
        new("canonical_ability_duplicate_stable_id", CanonicalAbilityCatalogTests.DuplicateStableIdIsRejected),
        new("canonical_ability_duplicate_sequence_scope", CanonicalAbilityCatalogTests.DuplicateSequenceInCanonicalScopeIsRejected),
        new("canonical_ability_unknown_registry_vocabulary", CanonicalAbilityCatalogTests.UnknownRequiredRegistryVocabularyIsRejected),
        new("canonical_ability_missing_template", CanonicalAbilityCatalogTests.MissingTemplateReferenceIsRejected),
        new("canonical_ability_malformed_required_field", CanonicalAbilityCatalogTests.MalformedRequiredFieldTypeIsRejected),
        new("canonical_template_normalization_deterministic", CanonicalTemplateCollectionZoneTests.TemplateNormalizationIsTypedDeterministicAndIsolated),
        new("canonical_template_binding_rejections", CanonicalTemplateCollectionZoneTests.TemplateArgumentAndBindingFailuresAreControlled),
        new("canonical_template_structured_equivalence", CanonicalTemplateCollectionZoneTests.TemplateAndStructuredGraphsHaveEquivalentRuntimeSemantics),
        new("canonical_collection_automatic_heal", CanonicalTemplateCollectionZoneTests.AutomaticCollectionHealUsesSnapshotAndCurrentDamage),
        new("canonical_filter_destroy", CanonicalTemplateCollectionZoneTests.NumericFiltersDriveDestroyAndMagnitudeEligibility),
        new("canonical_zone_dominion_to_hand", CanonicalTemplateCollectionZoneTests.DominionToHandMoveResetsStateAndPreservesProposal),
        new("canonical_effect_move_to_owner_hand", CanonicalTemplateCollectionZoneTests.MoveEffectUsesFilteredControllerChoiceAndOwnerHand),
        new("canonical_trigger_zone_changed_bridge", CanonicalTemplateCollectionZoneTests.ZoneChangedBridgeUsesAuthoritativeEventContext),
        new("canonical_new_primitive_atomic_rejection", CanonicalTemplateCollectionZoneTests.InvalidFilterAndMoveContractsRejectBeforeMutation),
        ...
        new("canonical_runtime_dependency_mismatch", CanonicalRuntimeBindingTests.CanonicalDependencyMismatchIsRejected),
        new("canonical_runtime_materialization_failure", CanonicalRuntimeBindingTests.CanonicalMaterializationFailureIsRejected),
        new("canonical_runtime_creation_failure_atomic", CanonicalRuntimeBindingTests.CanonicalCreationFailureIsAtomic),
        new("canonical_trigger_entered_play_real_ability", CanonicalRuntimeBindingTests.EnteredPlayBridgeAndRealAbilityAreDiscovered),
        new("canonical_trigger_keyword_resolution_negative", CanonicalRuntimeBindingTests.KeywordAndResolutionAbilitiesDoNotTrigger),
        new("canonical_trigger_entering_card_scope", CanonicalRuntimeBindingTests.DiscoveryIsRestrictedToEnteringCard),
        new("canonical_trigger_failed_play_legacy_negative", CanonicalRuntimeBindingTests.FailedPlayAndLegacyOnlySessionDoNotDiscover),
        new("canonical_trigger_hand_structural_negative", CanonicalRuntimeBindingTests.HandAndStructuralDomainPlacementDoNotDiscover),
        new("canonical_trigger_unsupported_invalid_source", CanonicalRuntimeBindingTests.UnsupportedEventReturnsEmptyAndInvalidSourceIsInvariant),
        new("canonical_trigger_immutable_deterministic", CanonicalRuntimeBindingTests.DiscoveryResultsAreImmutableAndDeterministic),
        new("canonical_execution_pending_projection_candidate_order", CanonicalAbilityExecutionTests.PendingCreationProjectionAndCandidateOrdering),
        new("canonical_execution_success_atomic_event_order", CanonicalAbilityExecutionTests.SuccessfulResolutionIsAtomicAndOrdered),
        new("canonical_execution_ward_non_attack_target", CanonicalAbilityExecutionTests.CanonicalWardDoesNotRestrictNonAttackTargeting),
        new("canonical_execution_no_target_auto_resolution", CanonicalAbilityExecutionTests.NoLegalTargetAutoResolvesWithoutDeadlock),
        new("canonical_execution_pending_gate", CanonicalAbilityExecutionTests.PendingGateBlocksNormalActionsForBothPlayers),
        new("canonical_execution_pending_identity_rejections", CanonicalAbilityExecutionTests.WrongPlayerUnknownPendingAndStaleRequestsAreImmutable),
        new("canonical_execution_target_shape_rejections", CanonicalAbilityExecutionTests.TargetShapeAndCardinalityRejectionsAreImmutable),
        new("canonical_execution_illegal_board_targets", CanonicalAbilityExecutionTests.IllegalBoardTargetsAndUnknownInstanceAreImmutable),
        new("canonical_execution_late_target_invalidation", CanonicalAbilityExecutionTests.TargetInvalidatedBeforeResolutionIsRejectedAtomically),
        new("canonical_execution_unsupported_effect", CanonicalAbilityExecutionTests.UnsupportedEffectActionIsControlledAndAtomic),
        new("canonical_execution_multiple_pending_choice", CanonicalAbilityExecutionTests.MultiplePendingTriggersAllowControllerChoice),
        new("canonical_execution_malformed_payload", CanonicalAbilityExecutionTests.MalformedResolutionPayloadIsImmutable),
        new("canonical_execution_deterministic", CanonicalAbilityExecutionTests.RepeatedExecutionIsDeterministic),
        new("canonical_damage_state_invariants", CanonicalDamageExecutionTests.DamageMarkedAndCommittedStateInvariants),
        new("canonical_damage_ign_lan_003_triggered", CanonicalDamageExecutionTests.IgnLan003RowUnrestrictedDamageAndLethalFlow),
        new("canonical_damage_ign_lan_031_played", CanonicalDamageExecutionTests.IgnLan031PlayedDamageIsAtomicAndCardinalityControlled),
        new("canonical_damage_aqu_art_044_sequence", CanonicalDamageExecutionTests.AquArt044SimulatesExhaustThenDamageAcrossTargets),
        new("canonical_damage_end_turn_cleanup_proxy", CanonicalDamageExecutionTests.EndTurnIsTemporaryDissipationDamageCleanupBoundary),
        new("canonical_damage_authority_and_projection", CanonicalDamageExecutionTests.DamageRequiresCanonicalStatsAndProjectionIsPublic),
        new("canonical_modifier_aqu_mor_033_snapshot_projection", CanonicalModifierKeywordDurationTests.AquMor033UsesSnapshotInstancesAndPublicProjection),
        new("canonical_modifier_aqu_mor_033_expiry_lethal", CanonicalModifierKeywordDurationTests.AquMor033ExpiryLossCanBeLethalBeforeDamageCleanup),
        new("canonical_modifier_ign_ham_036_041_generic", CanonicalModifierKeywordDurationTests.IgnHam036And041ShareGenericModifierGrantRuntime),
        new("canonical_modifier_keyword_multi_source", CanonicalModifierKeywordDurationTests.ModifierAndKeywordSourcesRemainIndependent),
        new("canonical_modifier_zone_sequence", CanonicalModifierKeywordDurationTests.ZoneSequencePreventsCrossZoneResurrection),
        new("canonical_modifier_debug_deterministic", CanonicalModifierKeywordDurationTests.DebugProjectionAndExpiryAreDeterministic),
        new("canonical_modifier_atomic_rejection", CanonicalModifierKeywordDurationTests.UnsupportedGraphsRejectWithoutPartialMutation),
        new("canonical_modifier_state_invariants", CanonicalModifierKeywordDurationTests.ContinuousEffectStateInvariantsRejectMalformedInstances),
        new("canonical_reference_ign_ham_020_public", CanonicalDrawReferenceRuntimeTests.IgnHam020PublicFlowUsesAutomaticSourceIdentity),
        new("canonical_reference_ign_ham_020_lethal", CanonicalDrawReferenceRuntimeTests.IgnHam020LethalPipelinesRemainSequential),
        new("canonical_reference_client_rejection", CanonicalDrawReferenceRuntimeTests.AutomaticReferencesRejectClientSelectionsAtomically),
        new("canonical_draw_aqu_mor_037_count", CanonicalDrawReferenceRuntimeTests.AquaMor037DrawsTwoOrThreeFromResolvedCount),
        new("canonical_draw_effective_ward", CanonicalDrawReferenceRuntimeTests.EffectiveWardQueryUsesIntrinsicGrantScopeAndExpiry),
        ...
        new("combat_phase_attacker_summoning_speed_legality", CombatSealFoundationTests.PhaseAttackerSummoningAndSpeedLegality),
        new("combat_horizon_zenith_ward_aerial_targeting", CombatSealFoundationTests.HorizonZenithWardAndAerialTargeting),
        new("combat_seal_slot_aeternal_legality", CombatSealFoundationTests.SealSlotAndAeternalDeclarationLegality),
        new("combat_attack_commit_atomic_bound_deterministic", CombatSealFoundationTests.AttackCommitIsAtomicBoundAndDeterministic),
        new("combat_reaction_closure_checkpoint_gate", CombatSealFoundationTests.ReactionClosureLeavesExplicitAttackCheckpointAndBlocksGameplay),
        new("combat_react_pass_lifo_regression", CombatSealFoundationTests.CombatWindowUsesExistingReactPassAndLifoSemantics),
        new("combat_projection_hidden_seal_privacy", CombatSealFoundationTests.CombatProjectionProtectsHiddenSealIdentity),
        new("combat_typed_continuation_invariant", CombatSealFoundationTests.CombatStateRejectsMalformedTypedContinuation),
        new("combat_repeated_protocol_deterministic", CombatSealFoundationTests.RepeatedCombatProtocolIsDeterministic),
        new("combat_intervention_candidate_adjacency", CombatSealFoundationTests.InterventionCandidatesUseLinearAdjacentOwnActiveHorizonEntities),
        new("combat_intervention_aerial_contact", CombatSealFoundationTests.InterventionRequiresMatchingAerialContact),
        new("combat_attack_checkpoint_continuity", CombatSealFoundationTests.AttackCheckpointUsesCommitRestrictionsAndContinuityOnly),
        new("combat_intervention_actions_atomic", CombatSealFoundationTests.InterventionActionsAreDefenderOnlyExactAndAtomic),
        new("combat_intervention_decline", CombatSealFoundationTests.DeclineInterventionAdvancesWithoutDefenseCommit),
        new("combat_defense_commit_reaction_open", CombatSealFoundationTests.DefenseCommitIsAtomicBoundAndOpensSecondReactionWindow),
        new("combat_defense_reaction_lifo_checkpoint", CombatSealFoundationTests.SecondCombatReactionPreservesReactPassLifoAndClosesAtDefenseCheckpoint),
        new("combat_defense_continuity_projection", CombatSealFoundationTests.DefenseCommitContinuityAndProjectionRemainViewerSafe),
        new("combat_c3_repeated_deterministic", CombatSealFoundationTests.RepeatedC3ProtocolIsDeterministic),
        new("combat_c4_undefended_simultaneous_persistent", CombatSealFoundationTests.UndefendedEntityCombatCommitsSimultaneousPersistentDamage),
        new("combat_c4_lethal_aftermath", CombatSealFoundationTests.EntityCombatLethalOutcomesUseCanonicalAftermath),
        new("combat_c4_current_effective_attack", CombatSealFoundationTests.CombatUsesCurrentEffectiveAttackAfterCommit),
        new("combat_c4_undefended_continuity_no_hit", CombatSealFoundationTests.UndefendedContinuityLossIsNoHitWithoutRetarget),
        new("combat_c4_defender_participant_continuity", CombatSealFoundationTests.CommittedDefenderIsExclusiveParticipantAndContinuityIsFinal),
        new("combat_c4_aerial_final_contact", CombatSealFoundationTests.FinalAerialContactRulesRemainPathSpecific),
        new("combat_c4_typed_provenance_determinism", CombatSealFoundationTests.CombatDamageProvenanceIsTypedAndDeterministic),
        new("combat_c5_seal_close_c6_aeternal_boundary", CombatSealFoundationTests.SealLifecycleClosesAndAeternalResolvesAtCheckpoint),
        new("combat_c5_seal_break_reveal_surge", CombatSealFoundationTests.SealBreakRevealAndSurgeLifecycleIsExactAndPublic),
        new("combat_c5_providence_eligibility_contract", CombatSealFoundationTests.ProvidenceEligibilityAndBlockingContractAreExact),
        new("combat_c5_providence_apply", CombatSealFoundationTests.ProvidenceApplyIsCanonicalAndDoesNotConsumeNormalInflow),
        new("combat_c5_providence_decline_atomic", CombatSealFoundationTests.ProvidenceDeclineAndInvalidRequestsAreAtomic),
        new("combat_c5_outcome_revalidation", CombatSealFoundationTests.SealOutcomeRevalidationAndStalePlansAreAtomic),
        new("combat_c5_state_invariants", CombatSealFoundationTests.PendingSurgeInvariantsRejectMalformedState),
        new("combat_c5_repeated_deterministic", CombatSealFoundationTests.RepeatedC5ProtocolIsDeterministic),
        new("combat_c6_aeternal_success_terminal", CombatSealFoundationTests.AeternalSuccessfulHitCommitsTerminalMatchResult),
        new("combat_c6_restored_seal_current_state", CombatSealFoundationTests.AeternalRestoredSealUsesCurrentOutcomeState),
        new("combat_c6_attacker_continuity", CombatSealFoundationTests.AeternalAttackerContinuityLossClosesWithoutVictory),
        new("combat_c6_declaration_only_not_revalidated", CombatSealFoundationTests.AeternalOutcomeIgnoresDeclarationOnlyRestrictions),
        new("combat_c6_terminal_action_gate", CombatSealFoundationTests.TerminalGameplayActionsAreRejectedAtomically),
        new("combat_c6_projection_events_privacy", CombatSealFoundationTests.TerminalProjectionAndEventsAreViewerSafe),
        new("combat_c6_plan_and_result_invariants", CombatSealFoundationTests.AeternalOutcomePlansAndMatchResultInvariantsAreGuarded),
        new("combat_c6_repeated_deterministic", CombatSealFoundationTests.RepeatedC6ProtocolIsDeterministic),
        new("combat_c4_plan_guards", CombatSealFoundationTests.CombatResolutionPlanningRejectsInvalidAndStaleCheckpoints),
        ...
        new("reaction_resolution_zone_not_void_while_open", ReactionPriorityTests.ReactablePlayDoesNotEnterVoidWhileWindowOpen),
        new("reaction_resolution_zone_public_projection", ReactionPriorityTests.ResolutionZoneProjectionIsPublic),
        new("reaction_resolution_zone_no_replay", ReactionPriorityTests.PendingResolutionCardCannotBeReplayed),
        new("reaction_resolution_zone_standard_to_void", ReactionPriorityTests.StandardClosureResolvesThenMovesToVoid),
        new("reaction_resolution_zone_reaction_first", ReactionPriorityTests.ReactionsResolveAboveUnderlyingCard),
        new("reaction_resolution_zone_invalidated_to_void", ReactionPriorityTests.InvalidatedUnderlyingStillMovesToVoid),
        new("reaction_resolution_zone_attempt_before_void", ReactionPriorityTests.VoidMoveFollowsResolutionAttemptEvent),
        new("reaction_resolution_zone_not_domain", ReactionPriorityTests.ResolutionIsNotDomainOrEnteredPlay),
        new("reaction_resolution_zone_no_capacity", ReactionPriorityTests.ResolutionHasNoSlotCapacityGate),
        new("reaction_resolution_zone_nonreactable_order", ReactionPriorityTests.NonReactableResolutionPreservesSemanticOrder),
        new("reaction_standard_pass_underlying_resolution", ReactionPriorityTests.StandardPassLifecycleAndUnderlyingResolution),
        new("reaction_declaration_reset_lifo", ReactionPriorityTests.ReactionDeclarationResetsPassesAndResolvesLifo),
        new("reaction_single_responder_terminal_policies", ReactionPriorityTests.SingleResponderAndTerminalPolicies),
        new("reaction_resolution_revalidation", ReactionPriorityTests.ResolutionRevalidationInvalidatesWithoutRetarget),
        new("reaction_rejected_requests_atomic", ReactionPriorityTests.RejectedRequestsAreAtomic),
        new("reaction_unsupported_profiles_controlled", ReactionPriorityTests.UnsupportedPoliciesChoicesAndNestingAreControlled),
        new("reaction_dynamic_lower_lethal_atomic", ReactionPriorityTests.DynamicLowerLethalTriggerBatchRejectsWholeClosureAtomically),
        new("reaction_technical_events_not_triggers", ReactionPriorityTests.TechnicalEventsAreNotTriggerSources),
        new("reaction_rc2_trigger_queue_checkpoint", ReactionPriorityTests.QueuedTriggersActivateAtPostResolutionCheckpoint),
        new("reaction_state_invariants", ReactionPriorityTests.StateInvariantsRejectMalformedReactionFamilies),
        new("reaction_protocol_deterministic", ReactionPriorityTests.RepeatedProtocolIsDeterministic),
        ...
        new("domain_debug_projection_tracks_coordinates", DomainStateTests.DebugProjectionTracksCoordinatesAndEntryTurn),
        new("domain_projection_is_defensive_and_non_mutating", DomainStateTests.ProjectionIsDefensiveAndNonMutating),
        new("domain_row_length_invariant", DomainStateTests.RowLengthInvariantIsEnforced),
        new("domain_duplicate_and_cross_zone_invariants", DomainStateTests.DuplicateAndCrossZoneInvariantsAreEnforced),
        new("domain_registry_and_occupancy_invariants", DomainStateTests.RegistryAndOccupancyInvariantsAreEnforced),
        new("domain_authority_visibility_activity_invariants", DomainStateTests.AuthorityVisibilityAndActivityInvariantsAreEnforced),
        new("domain_coordinate_and_entry_invariants", DomainStateTests.CoordinateAndEntryInvariantsAreEnforced),
        new("non_domain_coordinate_invariant", DomainStateTests.NonDomainCoordinatesAreRejected),
        new("domain_zone_index_sentinel_invariant", DomainStateTests.DomainZoneIndexSentinelIsEnforced),
        new("void_initial_state_and_serialized_contracts", VoidZoneTests.InitialStateAndSerializedContractsUseVoid),
        new("void_list_registry_parity", VoidZoneTests.VoidListAndRegistryParityIsAccepted),
        new("void_parity_and_cross_zone_rejections", VoidZoneTests.VoidParityAndCrossZoneViolationsAreRejected),
        new("void_rejects_retired_discard_zone_token", VoidZoneTests.RetiredDiscardZoneTokenIsRejected),
        new("play_card_legal_action_contract_and_availability", PlayCardTests.LegalActionContractAndAvailability),
        new("play_card_entity_to_horizon_atomic", PlayCardTests.EntityPlaysToHorizonAtomically),
        new("play_card_entity_to_zenith_active", PlayCardTests.EntityPlaysToZenithActive),
        new("play_card_mixed_realm_aether_payment", PlayCardTests.MixedRealmAndAetherPaymentIsExactAndOrdered),
        new("play_card_zero_cost_payment", PlayCardTests.ZeroCostRequiresEmptyPaymentAndEmitsNoPaymentEvent),
        new("play_card_repeated_execution_deterministic", PlayCardTests.RepeatedExecutionIsDeterministic),
        new("play_card_player_phase_stale_rejections", PlayCardTests.PlayerPhaseAndStaleRequestsAreImmutable),
        new("play_card_card_reference_type_rejections", PlayCardTests.CardReferenceAndTypeFailuresAreImmutable),
        new("play_card_magnitude_aura_rejections", PlayCardTests.MagnitudeAndAuraInsufficiencyAreImmutable),
        new("play_card_invalid_aura_sources", PlayCardTests.InvalidAuraSourcesAreImmutable),
        new("play_card_invalid_aura_counts", PlayCardTests.InvalidAuraCountsAndDuplicatesAreImmutable),
        new("play_card_invalid_destinations", PlayCardTests.InvalidAndOccupiedDestinationsAreImmutable),
        new("play_card_malformed_payload", PlayCardTests.MalformedPayloadIsImmutable),
        new("play_card_commit_revalidates_aura", PlayCardTests.CommitRevalidatesChangedAuraState),
        new("resolution_card_availability_projection_domain_independence", ResolutionCardPlayTests.AvailabilityProjectionAndDomainIndependence),
        new("resolution_card_success_atomic_ordered_viewer_safe", ResolutionCardPlayTests.SuccessfulPlayIsAtomicOrderedAndViewerSafe),
        new("resolution_card_payload_target_rejections", ResolutionCardPlayTests.PayloadAndTargetRejectionsAreAtomic),
        new("resolution_card_aura_policy_rejections", ResolutionCardPlayTests.AuraPolicyAndSelectionRejectionsAreAtomic),
        new("resolution_card_unsupported_graphs", ResolutionCardPlayTests.UnsupportedCanonicalGraphsAreControlledAndAtomic),
        new("resolution_card_late_revalidation_ward_ritual", ResolutionCardPlayTests.LateRevalidationWardAndRitualDispatch),
        new("resolution_card_deterministic", ResolutionCardPlayTests.RepeatedResolutionPlayIsDeterministic),
        ...
        new("runtime_provenance_legacy_without_provenance", RuntimePackageProvenanceTests.LegacyPackageWithoutProvenanceIsAccepted),
        new("runtime_provenance_canonical_success", RuntimePackageProvenanceTests.CanonicalPackageWithValidProvenanceIsAccepted),
        new("runtime_provenance_missing", RuntimePackageProvenanceTests.CanonicalPackageWithoutProvenanceIsRejected),
        new("runtime_provenance_runtime_id_mismatch", RuntimePackageProvenanceTests.RuntimePackageIdentityMismatchIsRejected),
        new("runtime_provenance_candidate_id_mismatch", RuntimePackageProvenanceTests.CandidateIdentityMismatchIsRejected),
        new("runtime_provenance_package_set_id_mismatch", RuntimePackageProvenanceTests.PackageSetIdentityMismatchIsRejected),
        new("runtime_provenance_materializer_id_invalid", RuntimePackageProvenanceTests.WrongMaterializerIdentityIsRejected),
        new("runtime_provenance_policy_id_invalid", RuntimePackageProvenanceTests.WrongMaterializationPolicyIsRejected),
        new("runtime_provenance_hash_malformed", RuntimePackageProvenanceTests.MalformedHashIsRejected),
        new("runtime_provenance_payload_tamper", RuntimePackageProvenanceTests.PayloadTamperIsRejected),
        new("runtime_provenance_hashed_file_missing", RuntimePackageProvenanceTests.MissingHashedFileIsRejected),
        new("runtime_provenance_path_unsafe", RuntimePackageProvenanceTests.UnsafeProvenancePathIsRejected),
        new("runtime_provenance_path_duplicate", RuntimePackageProvenanceTests.DuplicateManifestPathIsRejected),
        new("runtime_provenance_expected_package_id_mismatch", RuntimePackageProvenanceTests.ExpectedPackageIdentityMismatchIsRejected),
