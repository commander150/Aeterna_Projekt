...
class TestEngineMinimalSmokeCommand(unittest.TestCase):
    ...
    def test_main_prints_minimal_engine_smoke_report_and_returns_zero(self):
        ...
        self.assertIn("initial_legal_action_count: 2", output)
        self.assertIn("request_valid: true", output)
        self.assertIn("action_success: true", output)
        ...
        self.assertIn("last_event_type: turn_transition", output)
    ...
    def test_structured_smoke_report_is_json_compatible(self):
        ...
        self.assertEqual(report["initial_action_space"]["enabled_action_count"], 2)
        self.assertEqual(report["initial_action_space"]["actions"][0]["action_type"], "end_turn")
        self.assertEqual(report["initial_action_space"]["actions"][1]["action_type"], "draw_card")
        ...
        self.assertEqual(report["events"]["event_log"][0]["event_type"], "turn_transition")
