...
|---|---|---|---|---|---|---|---|
| AET-DOC-CARD-DATA-MODEL | AETERNA kártyaadatmodell | specification | 1.2 | active | current | technical-contract | `data/specifications/CARD_DATA_MODEL.md` |
| AET-DOC-CARD-DATA-WORKFLOW | AETERNA canonical kártyaadat-munkafolyamat | workflow | 1.2 | active | current | operational-workflow | `data/workflows/CARD_DATA_WORKFLOW.md` |
